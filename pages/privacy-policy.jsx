...
export default function PrivacyPolicy(){     
    return(
        <>
        <Head>
            <title>Business Needs Inc: Privacy Policy</title>
                    ...
                    <div className="content-page">
                        <div className="mission-content wow fadeInUp">
                            ...
                            <ul>
                                ...
                                <li>· <b>Website</b> refers to Business Needs, accessible from <Link href="/">https://www.businessneedsinc.com</Link></li>
                            ...
                            <h1 className="section-title">Collecting and Using Your Personal Data</h1>
                            ...
                            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target='_blank'>Free Privacy Policy website article</a>.</p>
                            <ul>
                            ...
                            <h1 className="section-title">Changes to this Privacy Policy</h1>
                            ...
                            <ul>
                               <li>· By visiting this page on our website: <Link href="/privacy-policy">https://www.businessneedsinc.com/privacy-policy</Link></li>
                            </ul> 
                          </div>
                    </div>
                </div>
